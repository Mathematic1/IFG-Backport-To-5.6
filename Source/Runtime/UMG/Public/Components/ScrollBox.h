...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnScrollBoxFocusReceivedEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnScrollBoxFocusLostEvent);
...
private:
	...
	/** Option to pass touch input events to widgets behind the ScrollBox. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Getter = "GetConsumePointerInput", Setter = "SetConsumePointerInput", Category = "Scroll", meta = (AllowPrivateAccess = "true", DisplayAfter = "bEnableTouchScrolling"))
	bool bConsumePointerInput = true;
		
	/** The virtual mouse wheel key for gamepad input */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Getter = "GetAnalogMouseWheelKey", Setter = "SetAnalogMouseWheelKey", Category = "Scroll", meta = (AllowPrivateAccess = "true", DisplayAfter = "bConsumePointerInput"))
	FKey AnalogMouseWheelKey;

	/** If true, scrollbox can receive focus. On gamepad, ensure AnalogMouseWheelKey is set to allow user interaction */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Getter = "GetIsFocusable", Setter = "SetIsFocusable", Category = "Scroll", meta = (AllowPrivateAccess = "true", DisplayAfter = "AnalogMouseWheelKey"))
	bool bIsFocusable;
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Scroll")
	UMG_API bool GetConsumePointerInput() const;

	UFUNCTION(BlueprintCallable, Category = "Scroll")
	UMG_API void SetConsumePointerInput(bool bInConsumePointerInput);
	...
	UFUNCTION(BlueprintCallable, Category = "Scroll")
	UMG_API FKey GetAnalogMouseWheelKey() const;

	UFUNCTION(BlueprintCallable, Category = "Scroll")
	UMG_API void SetAnalogMouseWheelKey(FKey InMouseWheelKey);

	UFUNCTION(BlueprintCallable, Category = "Scroll")
	UMG_API bool GetIsFocusable() const;

	UFUNCTION(BlueprintCallable, Category = "Scroll")
	UMG_API void SetIsFocusable(bool bInIsFocusable);
...
public:
	...
	FOnScrollBoxFocusReceivedEvent OnFocusReceived;

	/** Called when the scroll has changed */
	UPROPERTY(BlueprintAssignable, Category = "Scroll|Event")
	FOnScrollBoxFocusLostEvent OnFocusLost;
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Widget")
	UMG_API float GetOverscrollOffset() const;
	/**
	 * Gets the overscroll offset of the scrollbox in percentage from its view size.
	 */
	UFUNCTION(BlueprintCallable, Category="Widget")
	UMG_API float GetOverscrollPercentage() const;
	...
	UMG_API bool GetIsScrolling() const;
...
protected:
	...
	UMG_API void SlateHandleFocusReceived();
	
	UMG_API void SlateHandleFocusLost();
