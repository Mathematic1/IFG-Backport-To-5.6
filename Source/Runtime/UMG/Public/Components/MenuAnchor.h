...
public:
	...
	/** For menus using the application menu stack, should the window background be visible? */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Getter = "IsShowMenuBackground", AdvancedDisplay, Category = "Menu Anchor",  meta = (EditCondition = "UseApplicationMenuStack", EditConditionHides, AllowPrivateAccess = "true", DisplayAfter = "UseApplicationMenuStack"))
...
public:
	...
	UMG_API bool IsShowMenuBackground() const;
...
protected:
	...
	// Initialize ShowMenuBackground in the constructor before the SWidget is constructed.
	UMG_API void InitShowMenuBackground(bool InShowMenuBackground);
