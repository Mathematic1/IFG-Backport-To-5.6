...
public:
	...
	*/
	...
	virtual ~FOpenColorIOWrapperConfig() = default;
	...
	/** Get a color space description. */
	OPENCOLORIOWRAPPER_API FString GetColorSpaceDescription(const TCHAR* InColorSpaceName) const;
	...
	/** Get a display-view transform name. */
	OPENCOLORIOWRAPPER_API FString GetDisplayViewTransformName(const TCHAR* InDisplayName, const TCHAR* InViewName) const;

	/** Get a display-view transform name. */
	OPENCOLORIOWRAPPER_API FString GetDisplayViewDescription(const TCHAR* InDisplayName, const TCHAR* InViewName) const;

	/** Get a display-view transform description. */
	OPENCOLORIOWRAPPER_API FString GetDisplayViewTransformDescription(const TCHAR* InDisplayName, const TCHAR* InViewName) const;
