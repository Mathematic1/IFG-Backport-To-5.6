...
//
// If LLVM Clang is used, we require at minimum v18 to compile
//
#if defined(__clang__)
static_assert(__clang_major__ >= 18, "LLVM Clang v18 or greater is required to build Unreal Engine.");
#endif

//
// We require at minimum Visual Studio 2022 v17.8 to compile
//
