...
public:
	...
	[[nodiscard]] static PackedType ToPackedType(FloatType Value)
	{
		return *(PackedType*)&Value;
	}

	[[nodiscard]] static FloatType ToFloatType(PackedType Value)
	{
...
public:
	...
	[[nodiscard]] FloatType Decode(PackedType Value) const
	{
