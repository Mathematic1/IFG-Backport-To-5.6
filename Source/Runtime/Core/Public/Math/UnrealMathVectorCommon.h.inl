...
template<> FORCEINLINE VectorRegister4Float FGenericPlatformMath::Min(VectorRegister4Float A, VectorRegister4Float B)
{
	return VectorMin(A, B);
}

template<> FORCEINLINE VectorRegister4Double FGenericPlatformMath::Min(VectorRegister4Double A, VectorRegister4Double B)
{
	return VectorMin(A, B);
}

/** Returns the larger of the two values (operates on each component individually) */
template<> FORCEINLINE VectorRegister4Float FGenericPlatformMath::Max(VectorRegister4Float A, VectorRegister4Float B)
{
	return VectorMax(A, B);
}

template<> FORCEINLINE VectorRegister4Double FGenericPlatformMath::Max(VectorRegister4Double A, VectorRegister4Double B)
{
	return VectorMax(A, B);
}
