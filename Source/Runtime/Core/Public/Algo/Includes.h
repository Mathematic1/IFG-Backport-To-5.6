...
namespace Algo
{
	...
	[[nodiscard]] constexpr bool Includes(const RangeTypeA& RangeA, const RangeTypeB& RangeB)
	{
	...
	[[nodiscard]] constexpr bool Includes(const RangeTypeA& RangeA, const RangeTypeB& RangeB, SortPredicateType SortPredicate)
	{
	...
	[[nodiscard]] constexpr bool IncludesBy(const RangeTypeA& RangeA, const RangeTypeB& RangeB, ProjectionType Projection)
	{
	...
	[[nodiscard]] constexpr bool IncludesBy(const RangeTypeA& RangeA, const RangeTypeB& RangeB, ProjectionType Projection, SortPredicateType SortPredicate)
	{
