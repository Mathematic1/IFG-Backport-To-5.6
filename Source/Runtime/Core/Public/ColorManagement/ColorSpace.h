...
struct FColorSpaceTransform : FMatrix44d
{
	...
	*/
	CORE_API explicit FColorSpaceTransform(const FColorSpace& Src, const FColorSpace& Dst, EChromaticAdaptationMethod Method = DEFAULT_CHROMATIC_ADAPTATION_METHOD);
	...
	*/
	CORE_API static FMatrix44d CalcChromaticAdaptionMatrix(FVector3d SourceXYZ, FVector3d TargetXYZ, EChromaticAdaptationMethod Method = DEFAULT_CHROMATIC_ADAPTATION_METHOD);
