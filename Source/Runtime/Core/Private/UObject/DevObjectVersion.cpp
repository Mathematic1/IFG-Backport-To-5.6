...
// Register Dev-ParallelRendering custom version with Core
FDevSystemGuidRegistration GRegisterParallelRenderingBranchSystemGuids(FParallelRenderingObjectVersion::GetSystemGuids());
...
const FGuid FUE5SpecialProjectStreamObjectVersion::GUID(0x59DA5D52, 0x12324948, 0xB8785978, 0x70B8E98B);
// Register UE5 private frosty stream custom version with Core
FDevVersionRegistration GRegisterUE5SpecialProjectStreamObjectVersion(FUE5SpecialProjectStreamObjectVersion::GUID, FUE5SpecialProjectStreamObjectVersion::LatestVersion, TEXT("UE5-SpecialProject"));
FDevSystemGuidRegistration GRegisterUE5SpecialProjectStreamSystemGuids(FUE5SpecialProjectStreamObjectVersion::GetSystemGuids());
