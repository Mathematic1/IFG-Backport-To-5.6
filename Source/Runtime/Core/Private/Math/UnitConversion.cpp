...
constexpr FParseCandidate ParseCandidates[] = {
	...
	{ TEXT("Nits"),                 EUnit::Nit },                   { TEXT("nt"),       EUnit::Nit },
...
constexpr const TCHAR* const DisplayStrings[] = {
	...
	TEXT("lm"), TEXT("cd"), TEXT("lux"), TEXT("cd/m2"), TEXT("nt"), TEXT("EV"),
...
constexpr EUnitType UnitTypes[] = {
	...
	EUnitType::LuminousFlux, EUnitType::LuminousIntensity, EUnitType::Illuminance, EUnitType::Luminance, EUnitType::Luminance, EUnitType::ExposureValue,
