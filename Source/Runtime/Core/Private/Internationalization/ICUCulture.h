...
public:
	...
	TSharedRef<const icu::DecimalFormat, ESPMode::ThreadSafe> GetDateTimeDecimalFormat();
...
private:
	...
	TSharedPtr<const icu::DecimalFormat, ESPMode::ThreadSafe> ICUDateTimeDecimalFormat;
