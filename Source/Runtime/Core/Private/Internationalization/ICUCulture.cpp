...
namespace
{
	...
	TSharedRef<const icu::DateFormat, ESPMode::ThreadSafe> CreateDateFormat(const icu::Locale& ICULocale, const icu::DecimalFormat& ICUDecimalFormat)
	{
		...
		Ptr->setNumberFormat(ICUDecimalFormat);
		return Ptr.ToSharedRef();
	}

	TSharedRef<const icu::DateFormat, ESPMode::ThreadSafe> CreateTimeFormat(const icu::Locale& ICULocale, const icu::DecimalFormat& ICUDecimalFormat)
	{
	...
	TSharedRef<const icu::DateFormat, ESPMode::ThreadSafe> CreateDateTimeFormat(const icu::Locale& ICULocale, const icu::DecimalFormat& ICUDecimalFormat)
	{
...
TSharedRef<const icu::DecimalFormat, ESPMode::ThreadSafe> FICUCultureImplementation::GetDateTimeDecimalFormat()
{
	if (!ICUDateTimeDecimalFormat)
	{
		...
		// Sync the ICU decimal symbols with the ones we want to use for UE
		{
			const FDecimalNumberFormattingRules& NewUEDecimalNumberFormattingRules = GetDecimalNumberFormattingRules();

			icu::DecimalFormatSymbols ICUDecimalSymbols = *DecimalFormatterForCulture->getDecimalFormatSymbols();

			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kZeroDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[0], 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kOneDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[1], 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kTwoDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[2], 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kThreeDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[3], 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kFourDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[4], 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kFiveDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[5], 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kSixDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[6], 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kSevenDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[7], 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kEightDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[8], 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kNineDigitSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DigitCharacters[9], 1)), false);

			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kGroupingSeparatorSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.GroupingSeparatorCharacter, 1)), false);
			ICUDecimalSymbols.setSymbol(icu::DecimalFormatSymbols::kDecimalSeparatorSymbol, ICUUtilities::ConvertString(FStringView(&NewUEDecimalNumberFormattingRules.DecimalSeparatorCharacter, 1)), false);

			DecimalFormatterForCulture->setDecimalFormatSymbols(ICUDecimalSymbols);

			DecimalFormatterForCulture->setGroupingUsed(false);
		}

		ICUDateTimeDecimalFormat = DecimalFormatterForCulture;
	}

	return ICUDateTimeDecimalFormat.ToSharedRef();
}
...
TSharedRef<const icu::DateFormat, ESPMode::ThreadSafe> FICUCultureImplementation::GetDateFormatter(const EDateTimeStyle::Type DateStyle, const FString& TimeZone)
{
	...
	{
		ICUDateFormat = CreateDateFormat( ICULocale, *GetDateTimeDecimalFormat() );
	}
...
TSharedRef<const icu::DateFormat, ESPMode::ThreadSafe> FICUCultureImplementation::GetTimeFormatter(const EDateTimeStyle::Type TimeStyle, const FString& TimeZone)
{
	...
	{
		ICUTimeFormat = CreateTimeFormat( ICULocale, *GetDateTimeDecimalFormat() );
	}
	...
	else
	{
		...
		Formatter->adoptTimeZone(bIsDefaultTimeZone ? icu::TimeZone::createDefault() : icu::TimeZone::createTimeZone(InputTimeZoneID));
		Formatter->setNumberFormat(*GetDateTimeDecimalFormat());
		return Formatter.ToSharedRef();
	}
}
...
TSharedRef<const icu::DateFormat, ESPMode::ThreadSafe> FICUCultureImplementation::GetDateTimeFormatter(const EDateTimeStyle::Type DateStyle, const EDateTimeStyle::Type TimeStyle, const FString& TimeZone)
{
	...
	{
		ICUDateTimeFormat = CreateDateTimeFormat( ICULocale, *GetDateTimeDecimalFormat() );
	}
