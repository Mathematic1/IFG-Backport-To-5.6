...
TStaticArray<FVector2d, 4> FColorSpace::MakeChromaticities(UE::Color::EColorSpace ColorSpaceType)
{
	...
	case EColorSpace::PLASA_E1_54:
		...
		break;
	case EColorSpace::ACESCAM16:
		Chromaticities[0] = FVector2d(0.8336, 0.1735);
		Chromaticities[1] = FVector2d(2.3854, -1.4659);
		Chromaticities[2] = FVector2d(0.087, -0.125);
		Chromaticities[3] = FVector2d(0.333, 0.333);
		break;
