...
public:
	...
	/** In editor, outside a PIE session, will add all currently selected actors to the context data. */
	static AIMODULE_API void AddEditorSelectedActors(FEnvQueryContextData& ContextData);
