...
public:
	 ...
	 * @param SequenceID The SequenceID of the subsequence if importing one.
	*/
...
public:
	 ...
	 *
	 * @param OutTransformOrigins	The interrogated transforms for the currently focused sequence.
	 * @param SubsequenceHierarchy	The currently focused sequence hierarchy
	 * @param InstanceData			The object that contains the origin overrides for the world context object of the root sequence.
	 * 
	 */
	...
	{
		Channels.QueryTransformOrigins(Linker, Hierarchy, OutTransformOrigins, SubsequenceHierarchy, InstanceData);
	}
