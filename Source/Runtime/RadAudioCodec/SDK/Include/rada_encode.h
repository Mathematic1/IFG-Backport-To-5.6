...
// The build version of the rad audio library in it's entirety. This is distinct from the
// compilation version that determine linker compatibility. This is incremented each time
// the library is released
#define RADA_BUILD_VERSION (0x00000001U)

// Return the build version that the library was compiled with. This should match RADA_BUILD_VERSION!
