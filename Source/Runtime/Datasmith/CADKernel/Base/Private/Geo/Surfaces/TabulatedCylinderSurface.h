...
protected:
	 ...
	 */
	FTabulatedCylinderSurface(const double InToleranceGeometric, TSharedPtr<FCurve> InGuideCurve, const FVector& InDirectorVector, double InVMin = 0., double InVMax = 1.)
...
public:
	...
	FVector GetDirectorVector() const
	{
