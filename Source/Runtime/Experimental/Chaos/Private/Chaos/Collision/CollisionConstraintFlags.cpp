...
namespace Chaos
{
	...
	void FIgnoreCollisionManager::PopStorageData_Internal(int32 ExternalTimestamp)
	{
		...
		while(((StorageData = (StorageDataQueue.IsEmpty() ? nullptr : *StorageDataQueue.Peek())) != nullptr) && StorageData->ExternalTimestamp <= ExternalTimestamp)
		{
