...
float FAABBTreeCVars::DynamicTreeLeafEnlargePercent = 0.1f;
FAutoConsoleVariableRef FAABBTreeCVars::CVarDynamicTreeLeafEnlargePercent(TEXT("p.aabbtree.DynamicTreeLeafEnlargePercent"), FAABBTreeCVars::DynamicTreeLeafEnlargePercent, TEXT("Additional percentage added to bounding box of the leaf to amortize update cost. Ex: set 0.05 for 5%"));
