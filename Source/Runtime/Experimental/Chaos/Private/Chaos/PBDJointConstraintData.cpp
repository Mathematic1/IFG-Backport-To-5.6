...
namespace Chaos
{
	...
	void FJointConstraint::SetJointSettings(const FPBDJointSettings& NewSettings)
	{
		JointSettings.Modify(/*bInvalidate=*/true, DirtyFlags, Proxy, [&NewSettings](auto& Data)
		{
			Data = NewSettings;
		});
	}
