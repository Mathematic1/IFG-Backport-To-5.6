...
void GetGeomSurfaceSamples(const FSphere& InGeom, TArray<FVec3>& OutSamples)
{
	...
	const FReal Radius = InGeom.GetRadiusf();
...
void GetGeomSurfaceSamples(const FCapsule& InGeom, TArray<FVec3>& OutSamples)
{
	...
	FReal Radius = InGeom.GetRadiusf();
	FReal HalfHeight = InGeom.GetHeightf() * 0.5f;
...
bool FLevelSet::SweepGeom(const FSphere& QueryGeom, const FRigidTransform3& StartTM, const FVec3& Dir, const FReal Length, FReal& OutTime, FVec3& OutPosition, FVec3& OutNormal, int32& OutFaceIndex, const FReal Thickness, const bool bComputeMTD) const
{
...
bool FLevelSet::SweepGeom(const TImplicitObjectScaled<FSphere>& QueryGeom, const FRigidTransform3& StartTM, const FVec3& Dir, const FReal Length, FReal& OutTime, FVec3& OutPosition, FVec3& OutNormal, int32& OutFaceIndex, const FReal Thickness, const bool bComputeMTD) const
{
	return SweepGeomImp(QueryGeom, StartTM, Dir, Length, OutTime, OutPosition, OutNormal, OutFaceIndex, Thickness, bComputeMTD);
}
...
bool FLevelSet::OverlapGeom(const FSphere& QueryGeom, const FRigidTransform3& QueryTM, const FReal Thickness, FMTDInfo* OutMTD) const
{
...
bool FLevelSet::OverlapGeom(const TImplicitObjectScaled<FSphere>& QueryGeom, const FRigidTransform3& QueryTM, const FReal Thickness, FMTDInfo* OutMTD) const
{
	return OverlapGeomImp(QueryGeom, QueryTM, Thickness, OutMTD);
}
