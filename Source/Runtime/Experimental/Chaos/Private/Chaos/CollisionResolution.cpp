	...
	namespace Collisions
	{
		...
		*/
		...
		inline const FImplicitObject* GetInstancedImplicit(const FImplicitObject* Implicit0)
		{
			...
			{
				return Implicit0->template GetObject<const TImplicitObjectInstanced<FSphere>>()->GetInstancedObject();
			}
		...
		void UpdateSphereSphereConstraint(const FSphere& Sphere1, const FRigidTransform3& Sphere1Transform, const FSphere& Sphere2, const FRigidTransform3& Sphere2Transform, const FReal Dt, FPBDCollisionConstraint& Constraint)
		{
			...
			{
				UpdateContactPoint(Constraint, SphereSphereContactPoint(Sphere1, Sphere1Transform, Sphere2, Sphere2Transform, Constraint.GetCullDistancef()), Dt);
			}
		}
		...
		inline void UpdateConstraintFromGeometryImpl(FPBDCollisionConstraint& Constraint, const FRigidTransform3& WorldTransform0, const FRigidTransform3& WorldTransform1, const FReal Dt)
		{
			...
			case EContactShapesType::SphereSphere:
				UpdateSphereSphereConstraint(*Implicit0.template GetObject<FSphere>(), WorldTransform0, *Implicit1.template GetObject<FSphere>(), WorldTransform1, Dt, Constraint);
				break;
			case EContactShapesType::SphereCapsule:
				UpdateSphereCapsuleConstraint(*Implicit0.template GetObject<FSphere>(), WorldTransform0, *Implicit1.template GetObject<FCapsule>(), WorldTransform1, Dt, Constraint);
				break;
			case EContactShapesType::SphereBox:
				UpdateSphereBoxConstraint(*Implicit0.template GetObject<FSphere>(), WorldTransform0, *Implicit1.template GetObject<TBox<FReal, 3>>(), WorldTransform1, Dt, Constraint);
				break;
			case EContactShapesType::SphereConvex:
				UpdateSphereConvexConstraint(*Implicit0.template GetObject<FSphere>(), WorldTransform0, Implicit1, WorldTransform1, Dt, Constraint);
				break;
			case EContactShapesType::SphereTriMesh:
				...
				{
					UpdateSphereTriangleMeshConstraint(*Implicit0.template GetObject<FSphere>(), WorldTransform0, *ScaledTriMesh, WorldTransform1, Dt, Constraint);
					break;
				}
				...
				{
					UpdateSphereTriangleMeshConstraint(*Implicit0.template GetObject<FSphere>(), WorldTransform0, *TriangleMeshImplicit, WorldTransform1, Dt, Constraint);
					break;
				}
				ensure(false);
				break;
			case EContactShapesType::SphereHeightField:
				UpdateSphereHeightFieldConstraint(*Implicit0.template GetObject<FSphere>(), WorldTransform0, *Implicit1.template GetObject< FHeightField >(), WorldTransform1, Dt, Constraint);
				break;
			case EContactShapesType::SpherePlane:
				UpdateSpherePlaneConstraint(*Implicit0.template GetObject<FSphere>(), WorldTransform0, *Implicit1.template GetObject<TPlane<FReal, 3>>(), WorldTransform1, Dt, Constraint);
				break;
		...
		inline bool UpdateConstraintFromGeometrySweptImpl(FPBDCollisionConstraint& Constraint, const FRigidTransform3& WorldTransform0, const FRigidTransform3& WorldTransform1, const FReal Dt)
		{
			...
			if (bUseCCD)
			{
				...
				case EContactShapesType::SphereHeightField:
				{
					const FSphere* Object0 = Implicit0.template GetObject<const FSphere>();
		...
		EContactShapesType CalculateShapePairType(const FGeometryParticleHandle* Particle0, const FImplicitObject* Implicit0, const FGeometryParticleHandle* Particle1, const FImplicitObject* Implicit1, bool &bOutSwap)
		{
			...
			else if (Implicit0Type == FSphere::StaticType() && Implicit1Type == FSphere::StaticType())
			{
				return EContactShapesType::SphereSphere;
			}
			else if (Implicit0Type == FSphere::StaticType() && Implicit1Type == FHeightField::StaticType())
			{
				return EContactShapesType::SphereHeightField;
			}
			else if (Implicit0Type == FHeightField::StaticType() && Implicit1Type == FSphere::StaticType())
			{
				bOutSwap = true;
				return EContactShapesType::SphereHeightField;
			}
			else if (Implicit0Type == FSphere::StaticType() && Implicit1Type == TPlane<FReal, 3>::StaticType())
			{
				return EContactShapesType::SpherePlane;
			}
			else if (Implicit0Type == TPlane<FReal, 3>::StaticType() && Implicit1Type == FSphere::StaticType())
			{
				bOutSwap = true;
				return EContactShapesType::SpherePlane;
			}
			else if (Implicit0Type == FSphere::StaticType() && Implicit1Type == TBox<FReal, 3>::StaticType())
			{
				return EContactShapesType::SphereBox;
			}
			else if (Implicit0Type == TBox<FReal, 3>::StaticType() && Implicit1Type == FSphere::StaticType())
			{
				bOutSwap = true;
				return EContactShapesType::SphereBox;
			}
			else if (Implicit0Type == FSphere::StaticType() && Implicit1Type == FCapsule::StaticType())
			{
				return EContactShapesType::SphereCapsule;
			}
			else if (Implicit0Type == FCapsule::StaticType() && Implicit1Type == FSphere::StaticType())
			{
				bOutSwap = true;
				return EContactShapesType::SphereCapsule;
			}
			else if (Implicit0Type == FSphere::StaticType() && Implicit1Type == FImplicitConvex3::StaticType())
			{
				return EContactShapesType::SphereConvex;
			}
			else if (Implicit0Type == FImplicitConvex3::StaticType() && Implicit1Type == FSphere::StaticType())
			{
				bOutSwap = true;
				return EContactShapesType::SphereConvex;
			}
			...
			else if (Implicit0Type == FSphere::StaticType() && Implicit1Type == FTriangleMeshImplicitObject::StaticType())
			{
				return EContactShapesType::SphereTriMesh;
			}
			else if (Implicit0Type == FTriangleMeshImplicitObject::StaticType() && Implicit1Type == FSphere::StaticType())
			{
				bOutSwap = true;
				return EContactShapesType::SphereTriMesh;
			}
