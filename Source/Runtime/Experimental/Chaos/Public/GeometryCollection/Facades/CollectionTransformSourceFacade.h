...
namespace GeometryCollection::Facades
{
	...
	*/
	...
	public:
		...
		static CHAOS_API const FName SourceSkeletalMeshNameAttributeName;
		/**
		...
		* @param SKMName : Name of the skeletal mesh owner of the transform set.
		*/
	...
	private:
		...
		TManagedArrayAccessor<FString> SourceSkeletalMeshNameAttribute;
	};
