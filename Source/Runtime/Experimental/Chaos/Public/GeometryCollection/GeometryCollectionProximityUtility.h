...
public:
	...
	// Method to compute the precise proximity, regardless of the proximity configuration on the collection
	CHAOS_API static TArray<TSet<int32>> ComputePreciseProximity(const FGeometryCollection& InCollection);
...
private:
	...
	static constexpr float PreciseProximityThreshold = .01f;
};
