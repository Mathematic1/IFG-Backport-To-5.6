...
namespace Chaos
{
	namespace Utilities
	{
		...
		FORCEINLINE_DEBUGGABLE decltype(auto) CastHelper(const FImplicitObject& Geom, const Lambda& Func)
		{
			...
			{
				return Func(Geom.template GetObjectChecked<FSphere>());
			}
			...
			{
				return Func(Geom.template GetObjectChecked<TImplicitObjectScaled<FSphere>>());
			}
			...
			{
				return Func(Geom.template GetObjectChecked< TImplicitObjectInstanced<FSphere>>().GetInstancedObject()->template GetObjectChecked<FSphere>());
			}
			...
			return Func(Geom.template GetObjectChecked<FSphere>());	//needed for return type
		}
		...
		FORCEINLINE_DEBUGGABLE decltype(auto) CastHelper(const FImplicitObject& Geom, const FRigidTransform3& TM, const Lambda& Func)
		{
			...
			switch (Type)
			{
			case ImplicitObjectType::Sphere: return Func(Geom.template GetObjectChecked<FSphere>(), TM);
			...
			case ImplicitObjectType::IsScaled | ImplicitObjectType::Sphere: return Func(Geom.template GetObjectChecked<TImplicitObjectScaled<FSphere>>(), TM);
			...
			case ImplicitObjectType::IsInstanced | ImplicitObjectType::Sphere:
			{
				return Func(Geom.template GetObjectChecked< TImplicitObjectInstanced<FSphere>>().GetInstancedObject()->template GetObjectChecked<FSphere>(), TM);
			}
			case ImplicitObjectType::IsInstanced | ImplicitObjectType::Box:
			{
			...
			return Func(Geom.template GetObjectChecked<FSphere>(), TM);	//needed for return type
		}
		...
		FORCEINLINE_DEBUGGABLE decltype(auto) CastHelperNoUnwrap(const FImplicitObject& Geom, const FRigidTransform3& TM, const Lambda& Func)
		{
			...
			case ImplicitObjectType::IsScaled | ImplicitObjectType::Capsule: return Func(Geom.template GetObjectChecked< TImplicitObjectScaled<FCapsule>>(), TM);
			case ImplicitObjectType::IsScaled | ImplicitObjectType::Convex: return Func(Geom.template GetObjectChecked< TImplicitObjectScaled<FConvex>>(), TM);
			case ImplicitObjectType::IsInstanced | ImplicitObjectType::Sphere: return Func(Geom.template GetObjectChecked< TImplicitObjectInstanced<FSphere>>(), TM);
		...
		FORCEINLINE_DEBUGGABLE decltype(auto) CastHelperNoUnwrap(const FImplicitObject& Geom, const FRigidTransform3& TM0, const FRigidTransform3& TM1, const Lambda& Func)
		{
			...
			switch (Type)
			{
			case ImplicitObjectType::Sphere: return Func(Geom.template GetObjectChecked<FSphere>(), TM0, TM1);
			...
			case ImplicitObjectType::IsScaled | ImplicitObjectType::Sphere: return Func(Geom.template GetObjectChecked<TImplicitObjectScaled<FSphere>>(), TM0, TM1);
			...
			case ImplicitObjectType::IsInstanced | ImplicitObjectType::Sphere: return Func(Geom.template GetObjectChecked< TImplicitObjectInstanced<FSphere>>(), TM0, TM1);
			...
			return Func(Geom.template GetObjectChecked<FSphere>(), TM0, TM1);	//needed for return type
		}
		...
		const FImplicitObject* ImplicitChildHelper(const FImplicitObject* ImplicitObject)
		{
			...
			else if (ImplicitType == TImplicitObjectScaled<FSphere>::StaticType())
			{
				return ImplicitObject->template GetObject<const TImplicitObjectScaled<FSphere>>()->GetUnscaledObject();
			}
			...
			else if (ImplicitType == TImplicitObjectInstanced<FSphere>::StaticType())
			{
				return ImplicitObject->template GetObject<const TImplicitObjectInstanced<FSphere>>()->GetInstancedObject();
			}
