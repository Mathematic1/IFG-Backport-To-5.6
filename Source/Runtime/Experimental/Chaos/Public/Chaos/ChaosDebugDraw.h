...
namespace Chaos
{
	...
	namespace DebugDraw
	{
		...
		CHAOS_API void DrawSimulationSpace(const FTransform& SpaceTransform, const FSimulationSpace& SimSpace, const FChaosDebugDrawSettings* Settings = nullptr);
		...
		UE_DEPRECATED(5.5, "Now requires SpaceTransform as first parameter")
		inline void DrawSimulationSpace(const FSimulationSpace& SimSpace, const FChaosDebugDrawSettings* Settings = nullptr)
		{
		}
#endif
	}
