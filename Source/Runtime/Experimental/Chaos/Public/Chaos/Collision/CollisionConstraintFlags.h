...
namespace Chaos
{
	...
	*/
	...
	private:
		...
		TSpscQueue<FStorageData*> StorageDataQueue; // Queue of storage data being passed to physics thread
		TSpscQueue<FStorageData*> StorageDataFreePool;	//free pool of storage data
