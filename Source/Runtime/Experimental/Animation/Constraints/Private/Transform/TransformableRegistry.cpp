...
void FTransformableRegistry::Register(UClass* InClass, CreateHandleFuncT InHandleFunc, GetHashFuncT InHashFunc)
{
...
void FTransformableRegistry::RegisterBaseObjects()
{
    ...
    auto CreateComponentHandle = [](UObject* InObject, const FName& InSocketName)->UTransformableHandle*
    {
    	...
    	{
    		return UE::TransformConstraintUtil::CreateHandleForSceneComponent(Component, InSocketName);
    	}
    	return nullptr;
    };
