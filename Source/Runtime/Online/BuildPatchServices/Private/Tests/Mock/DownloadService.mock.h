...
namespace BuildPatchServices
{
	...
	public:
		...
		virtual int32 RequestFileWithHeaders(const FString& FileUri, const TMap<FString, FString>& Headers, const FDownloadCompleteDelegate& OnCompleteDelegate, const FDownloadProgressDelegate& OnProgressDelegate) override
		{
			return RequestFile(FileUri, OnCompleteDelegate, OnProgressDelegate);
		}
