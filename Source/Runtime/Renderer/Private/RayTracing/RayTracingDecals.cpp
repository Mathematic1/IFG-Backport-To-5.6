	...
	EUniformBufferUsage Usage)
{
	...
	Parameters.DecalColorParam = VisibleDecal.DecalColor;
	...
	Parameters.DecalParams = FVector2f(VisibleDecal.FadeAlpha, LifetimeAlpha);
	Parameters.DecalColorParam = VisibleDecal.DecalColor;

	Parameters.DecalWriteFlags = CalculateDecalWriteFlags(VisibleDecal.BlendDesc);
...
class FRayTracingBuildDecalGridCS : public FGlobalShader
{
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		...
		SHADER_PARAMETER_RDG_TEXTURE_UAV(RWTexture2DArray<uint>, RWDecalGrid)
