...
public:
		...
		FMeshDrawSingleShaderBindings& ShaderBindings) const
	{
		...
		// bind Lumen Hardware RT buffer
		ShaderBindings.Add(GetUniformBufferParameter<FLumenHardwareRayTracingUniformBufferParameters>(), View.LumenHardwareRayTracingUniformBuffer);
	}
