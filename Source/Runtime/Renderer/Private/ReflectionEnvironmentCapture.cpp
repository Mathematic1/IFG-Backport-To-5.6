	...
	bool bCapturingForMobile)
{
	...
	UE_CLOG(FSceneCaptureLogUtils::bEnableSceneCaptureLogging, LogSceneCapture, Log, TEXT("Starting CaptureSceneToScratchCubemap Face: %d, Size: %d, bCapturingForSkylight: %d"), CubeFace, CubemapSize, (int32) bCapturingForSkyLight);
...

	{
		...
		UE_CLOG(FSceneCaptureLogUtils::bEnableSceneCaptureLogging, LogSceneCapture, Log, TEXT("Ending CaptureSceneToScratchCubemap Face: %d, Size: %d, bCapturingForSkylight: %d"), CubeFace, CubemapSize, (int32) bCapturingForSkyLight);
	}
