	...
	FVertexInputStreamArray& VertexStreams) const
{
	...
	bool PlatformUsesPrimitiveUB = false;
	if (PlatformGPUSceneUsesUniformBufferView(ShaderPlatform))
	{
		// On platforms that use "UniformView" GPUScene, some VF might bind primitive UB
		// this includes ISM VFs and mesh particles
		PlatformUsesPrimitiveUB = (BatchElement.bForceInstanceCulling || (PrimitiveSceneProxy && PrimitiveSceneProxy->DoesVFRequirePrimitiveUniformBuffer()));
	}
