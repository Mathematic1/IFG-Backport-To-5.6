...
namespace LumenRadianceCache
{
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FRadianceCacheInputs, )
		...
		SHADER_PARAMETER(uint32, BlendProbes)
		SHADER_PARAMETER(uint32, UseSkyVisibility)
		SHADER_PARAMETER(uint32, UseAdaptiveProbes)
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FRadianceCacheInterpolationParameters, )
		...
		SHADER_PARAMETER_RDG_TEXTURE(Texture2D<uint>, RadianceCacheProbeValidAtlas)
		...
		SHADER_PARAMETER(FVector2f, FinalIrradianceAtlasTexelSize)
		SHADER_PARAMETER(FVector2f, FinalOcclusionAtlasTexelSize)
		...
		SHADER_PARAMETER(uint32, FinalIrradianceProbeResolution)
    	SHADER_PARAMETER(uint32, FinalOcclusionProbeResolution)
	END_SHADER_PARAMETER_STRUCT()
