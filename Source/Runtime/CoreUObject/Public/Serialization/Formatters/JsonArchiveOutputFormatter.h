...
public:
	...
	COREUOBJECT_API virtual void Serialize(UTF32CHAR& Value) override;
	...
	COREUOBJECT_API virtual void Serialize(Verse::VCell*& Value) override;
#endif
...
#if WITH_VERSE_VM || defined(__INTELLISENSE__)
	void SetCellIndicesMap(const TMap<Verse::VCell*, FPackageIndex>* InCellIndicesMap)
	{
		CellIndicesMap = InCellIndicesMap;
	}
#endif
...
#if WITH_VERSE_VM || defined(__INTELLISENSE__)
	const TMap<Verse::VCell*, FPackageIndex>* CellIndicesMap = nullptr;
#endif
...
#if WITH_VERSE_VM || defined(__INTELLISENSE__)
	COREUOBJECT_API bool IsCellAllowed(Verse::VCell* InCell) const;
#endif
};
