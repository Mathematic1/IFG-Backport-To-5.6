...
typedef void (*FFlushCompilationQueueFPtr)(FUObjectSerializeContext*);
...
struct FBlueprintSupport
{
	...
	COREUOBJECT_API static void SetFlushCompilationQueueFPtr(FFlushCompilationQueueFPtr Ptr);
