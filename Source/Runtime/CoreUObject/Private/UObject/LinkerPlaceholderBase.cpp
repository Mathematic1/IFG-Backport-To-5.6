...
//------------------------------------------------------------------------------
template<>
int32 TLinkerImportPlaceholder<UClass>::SpecializedResolvePropertyReferences(UClass* ReplacementClass)
{
	int32 ReplacementCount = 0;
...
//------------------------------------------------------------------------------
template<>
int32 TLinkerImportPlaceholder<UFunction>::SpecializedResolvePropertyReferences(UFunction* ReplacementFunc)
{
	int32 ReplacementCount = 0;
