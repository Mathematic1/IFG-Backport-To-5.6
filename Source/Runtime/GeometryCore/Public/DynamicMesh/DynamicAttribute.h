...
public:
	...
	UE_DEPRECATED(5.6, "Use the version of this method that takes a TSet instead")
...
public:
	 ...
	 * @return true if the append succeeded, false otherwise (e.g. false if the data from the source attribute was not compatible and the CopyOut failed to copy across)
	 */
	...
	*/
	...
	virtual SIZE_T GetByteCount() const { return 0; }
