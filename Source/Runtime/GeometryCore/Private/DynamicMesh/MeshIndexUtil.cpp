...
void UE::Geometry::TriangleToVertexIDs(const FDynamicMesh3* Mesh, TConstArrayView<int> TriangleIDs, TArray<int>& VertexIDsOut)
{
...
void UE::Geometry::VertexToTriangleOneRing(const FDynamicMesh3* Mesh, TConstArrayView<int> VertexIDs, TSet<int>& TriangleIDsOut)
{
