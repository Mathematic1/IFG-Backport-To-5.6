...
public:
	...
	ENGINE_API void SetAttributes(UE::Anim::FMeshAttributeContainer& InAttributes);
	...
	ENGINE_API const UE::Anim::FMeshAttributeContainer& GetAttributes() const;
...
private:
	...
	UE::Anim::FMeshAttributeContainer MeshAttributes;
