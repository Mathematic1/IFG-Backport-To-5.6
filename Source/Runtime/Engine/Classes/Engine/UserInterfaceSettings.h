...
public:
	...
	ENGINE_API void ForceLoadResources(bool bForceLoadEverything = false) const;
...
private:
	// This is just holding on to references to prevent GC in the Editor (tied to the lifetime of this object)
	UPROPERTY(Transient)
	mutable TArray<TObjectPtr<UObject>> CursorClasses;
