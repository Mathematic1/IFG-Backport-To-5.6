...
inline constexpr uint32 PackedRelativeBox_Identity = 0xffff0000;
...
inline constexpr uint16 InvalidRegisteredStreamableTexture = (uint16)INDEX_NONE;
...
public:
	...
	void SetForceNoUseBuiltData(bool bValue) { bForceNoUseBuiltData = bValue; }
