...
public:
	 ...
	 */
	UE_DEPRECATED(5.6, "Replaced by private OnGameWindowMoved_SavePosition function.")
...
private:
	 ...
	 * Called when the game window is moved
	 */
	void OnGameWindowMoved_SavePosition(const TSharedRef<SWindow>& WindowBeingMoved, int32 SaveWinPosIndex);
