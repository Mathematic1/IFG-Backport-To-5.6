...
public:
	 ...
	 */
	UFUNCTION(BlueprintPure, CustomThunk, meta = (DisplayName = "Get Key Value By Index", CompactNodeTitle = "GET KEY VALUE BY INDEX", MapParam = "TargetMap", MapKeyParam = "Key", MapValueParam = "Value", AutoCreateRefTerm = "Key, Value", BlueprintThreadSafe), Category = "Utilities|Map")
	static ENGINE_API void Map_GetKeyValueByIndex(const TMap<int32, int32>& TargetMap, int32 Index, int32& Key, int32& Value);
	 ...
	 * @return	The number of entries in the map
	 */
	UFUNCTION(BlueprintPure, CustomThunk, meta=(DisplayName = "Get Last Index", CompactNodeTitle = "GET LAST INDEX", MapParam = "TargetMap", BlueprintThreadSafe), Category="Utilities|Map")
	static ENGINE_API int32 Map_GetLastIndex(const TMap<int32, int32>& TargetMap);
	...
	DECLARE_FUNCTION(execMap_GetKeyValueByIndex)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		GenericMap_GetKeyValueByIndex(MapAddr, MapProperty, Index, KeyPtr, ItemPtr);
		P_NATIVE_END;
	...
	DECLARE_FUNCTION(execMap_GetLastIndex)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(int32*)RESULT_PARAM = GenericMap_GetLastIndex(MapAddr, MapProperty);
		P_NATIVE_END
	}
	...
	static ENGINE_API void GenericMap_GetKeyValueByIndex(const void* TargetMap, const FMapProperty* MapProperty, int32 Index, void* KeyPtr, void* ValuePtr);
	static ENGINE_API int32 GenericMap_GetLastIndex(const void* TargetMap, const FMapProperty* MapProperty);
