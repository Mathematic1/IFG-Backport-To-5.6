...
struct FImportanceTexture
{
	...
	UE_DEPRECATED(5.6, "FColor TextureData has been deprecated, use LinearTextureData")
	UPROPERTY(Transient, meta = (DeprecatedProperty, DeprecationMessage = "Please use LinearTextureData instead."))
