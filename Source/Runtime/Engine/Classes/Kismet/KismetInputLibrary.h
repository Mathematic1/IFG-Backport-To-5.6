...
class UKismetInputLibrary : public UBlueprintFunctionLibrary
{
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Key Display Name", BlueprintAutocast), Category="Input|Key")
