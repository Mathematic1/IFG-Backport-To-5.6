...
class UCameraComponent : public USceneComponent
{
	 ...
	 */
	UPROPERTY(meta = (UIMin="0.0", ClampMin="0.0", UIMax="1.0", ClampMax="1.0"))
	FVector4f AsymmetricOverscan = FVector4f::Zero();
	UFUNCTION()
	void SetAsymmetricOverscan(const FVector4f& InAsymmetricOverscan) { AsymmetricOverscan = InAsymmetricOverscan; }
