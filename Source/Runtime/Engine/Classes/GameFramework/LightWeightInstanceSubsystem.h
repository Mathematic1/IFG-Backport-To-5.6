...
struct FLightWeightInstanceSubsystem
{
	...
	{
		static TSharedPtr<FLightWeightInstanceSubsystem, ESPMode::ThreadSafe> LWISubsystemSingleton = []
		{
			return MakeShareable(new FLightWeightInstanceSubsystem());
		}();
		return *LWISubsystemSingleton;
	}
...
private:
	...
	mutable FTransactionallySafeRWLock LWIManagersRWLock;
