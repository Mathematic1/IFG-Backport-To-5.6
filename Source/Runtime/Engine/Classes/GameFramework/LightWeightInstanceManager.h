...
public:
	...
	virtual UClass* GetRepresentedClass(const int32 InstanceIndex) const override { return GetRepresentedClassInternal(); }
	virtual ULevel* GetLevelForInstance(const int32 InstanceIndex) const override { return GetLevel(); }
