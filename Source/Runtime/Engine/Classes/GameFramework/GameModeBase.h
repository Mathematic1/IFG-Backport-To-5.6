...
public:
	...
	UE_DEPRECATED(5.6, "This functionality has been moved into OnPostLogin. You cannot call that function directly, it is executed at the end of PostLogin.")
	ENGINE_API void DispatchPostLogin(AController* NewPlayer);

protected:
	/** Called as part of the PostLogin process.  This is the last step before we spawn a new player. */
	ENGINE_API virtual void OnPostLogin(AController* NewPlayer);
