...
void FPreviewAssetAttachContainer::RemoveAtSwap( int32 Index, EAllowShrinking AllowShrinking /*=EAllowShrinking::Default */ )
{
	AttachedObjects.RemoveAtSwap( Index, AllowShrinking );
}

void FPreviewAssetAttachContainer::RemoveAtSwap( int32 Index, int32 Count, EAllowShrinking AllowShrinking /*=EAllowShrinking::Default */ )
{
