...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	bool SupportsDynamicChanges(UWorld* World)
	{
		return Delegates.SupportsDynamicChangesDelegate.Execute(World);
	}
...
FNavigationSystem::FSupportsDynamicChangesSignature& UNavigationSystemBase::GetSupportsDynamicChangesDelegate()
{
	return FNavigationSystem::Delegates.SupportsDynamicChangesDelegate;
}
