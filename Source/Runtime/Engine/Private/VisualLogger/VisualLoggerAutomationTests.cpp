...
void FVisualLoggerTestDevice::Serialize(const UObject* InLogOwner, const FName& InOwnerName, const FName& InOwnerDisplayName, const FName& InOwnerClassName, const FVisualLogEntry& InLogEntry)
{
	LastObject = const_cast<class UObject*>(InLogOwner);
	LastEntry = InLogEntry;
}
