...
bool UWorldPartition::GatherPackagesToCook(IWorldPartitionCookPackageContext& CookContext)
{
	...
	{
		IWorldPartitionCookPackageObject* CookPackageObject = GetCookPackageObject(FWorldPartitionCookPackage(TEXT("<Root>"), PackageName, FWorldPartitionCookPackage::EType::Level, FWorldPartitionPackageHash()));
