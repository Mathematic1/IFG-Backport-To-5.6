...
void FAnimNodePoseWatch::SetAttributes(UE::Anim::FMeshAttributeContainer& InAttributes)
{
	MeshAttributes.MoveFrom(InAttributes);
}
...
const UE::Anim::FMeshAttributeContainer& FAnimNodePoseWatch::GetAttributes() const
{
