...
void FSkinWeightDataVertexBuffer::SetMetaData(uint32 InNumVertices, uint32 InMaxBoneInfluences, bool bInUse16BitBoneIndex, bool bInUse16BitBoneWeight)
{
	NumVertices = InNumVertices;
	bUse16BitBoneIndex = bInUse16BitBoneIndex;
	bUse16BitBoneWeight = bInUse16BitBoneWeight;

	SetMaxBoneInfluences(InMaxBoneInfluences);
	NumBoneWeights = NumVertices * MaxBoneInfluences;
}
...
{
	static const FName DataVertexBufferName(TEXT("FSkinWeightVertexBuffer.DataVertexBuffer"));
	static const FName LookupVertexBufferName(TEXT("FSkinWeightVertexBuffer.LookupVertexBuffer"));
} // SkeletalMeshResourceNames

FSkinWeightVertexBuffer::FSkinWeightVertexBuffer()
{
	DataVertexBuffer.SetResourceName(SkeletalMeshResourceNames::DataVertexBufferName);
	LookupVertexBuffer.SetResourceName(SkeletalMeshResourceNames::LookupVertexBufferName);
}
