...
bool UParticleModuleSpawnPerUnit::GetSpawnAmount(const FContext& Context, 
	int32 Offset, float OldLeftover, float DeltaTime, int32& Number, float& Rate)
{
	...
	float ParticlesPerUnit = SpawnPerUnit.GetValue(Owner->EmitterTime, Context.GetDistributionData()) / UnitScalar;
