...
FParticleEmitterInstance* UParticleModuleTypeDataRibbon::CreateInstance(UParticleEmitter* InEmitterParent, IParticleEmitterInstanceOwner& InComponent)
{
	FParticleEmitterInstance* Instance = new FParticleRibbonEmitterInstance(InComponent);
	check(Instance);
...
FParticleEmitterInstance* UParticleModuleTypeDataAnimTrail::CreateInstance(UParticleEmitter* InEmitterParent, IParticleEmitterInstanceOwner& InComponent)
{
	FParticleEmitterInstance* Instance = new FParticleAnimTrailEmitterInstance(InComponent);
	check(Instance);
	Instance->InitParameters(InEmitterParent);
	return Instance;
}
