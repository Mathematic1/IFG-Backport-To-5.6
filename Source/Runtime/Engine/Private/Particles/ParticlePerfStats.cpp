...
void FParticlePerfStats::PopulateStatNames(const FName InName)
{
	if (CSVStat_Total == NAME_None)
	{
		...
		CSVStat_Total = FName(*FString::Printf(TEXT("Total/%s"), *StatName), 0, false);
		CSVStat_GTOnly = FName(*FString::Printf(TEXT("GTOnly/%s"), *StatName), 0, false);
		CSVStat_InstAvgGT = FName(*FString::Printf(TEXT("InstAvgGT/%s"), *StatName), 0, false);
		CSVStat_RT = FName(*FString::Printf(TEXT("RT/%s"), *StatName), 0, false);
		CSVStat_InstAvgRT = FName(*FString::Printf(TEXT("InstAvgRT/%s"), *StatName), 0, false);
		CSVStat_GPU = FName(*FString::Printf(TEXT("GPU/%s"), *StatName), 0, false);
		CSVStat_InstAvgGPU = FName(*FString::Printf(TEXT("InstAvgGPU/%s"), *StatName), 0, false);
		CSVStat_Count = FName(*FString::Printf(TEXT("Count/%s"), *StatName), 0, false);
		CSVStat_Activation = FName(*FString::Printf(TEXT("Activation/%s"), *StatName), 0, false);
		CSVStat_Waits = FName(*FString::Printf(TEXT("Waits/%s"), *StatName), 0, false);
		CSVStat_Culled = FName(*FString::Printf(TEXT("Culled/%s"), *StatName), 0, false);
		CSVStat_MemoryKB = FName(*FString::Printf(TEXT("MemoryKB/%s"), *StatName), 0, false);
	}
}
