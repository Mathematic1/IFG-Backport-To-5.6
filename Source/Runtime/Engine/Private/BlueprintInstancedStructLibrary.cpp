...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BlueprintInstancedStructLibrary)

#define LOCTEXT_NAMESPACE "UBlueprintInstancedStructLibrary"
...
void UBlueprintInstancedStructLibrary::SetInstancedStructValue(FInstancedStruct& InstancedStruct, const int32& Value)
{
	// We should never hit this! stubs to avoid NoExport on the class.
	checkNoEntry();
}

void UBlueprintInstancedStructLibrary::GetInstancedStructValue(EStructUtilsResult& ExecResult, const FInstancedStruct& InstancedStruct, int32& Value)
{
	// We should never hit this! stubs to avoid NoExport on the class.
	checkNoEntry();
}
...
DEFINE_FUNCTION(UBlueprintInstancedStructLibrary::execSetInstancedStructValue)
{
...
DEFINE_FUNCTION(UBlueprintInstancedStructLibrary::execGetInstancedStructValue)
{
