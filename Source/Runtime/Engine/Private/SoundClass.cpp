...
void USoundClass::AddAssetUserData(UAssetUserData* InUserData)
{
...
UAssetUserData* USoundClass::GetAssetUserDataOfClass(TSubclassOf<UAssetUserData> InUserDataClass)
{
...
void USoundClass::RemoveUserDataOfClass(TSubclassOf<UAssetUserData> InUserDataClass)
{
	for (int32 DataIdx = 0; DataIdx < AssetUserData.Num(); DataIdx++)
	{
		UAssetUserData* Datum = AssetUserData[DataIdx];
...
const TArray<UAssetUserData*>* USoundClass::GetAssetUserDataArray() const
{
