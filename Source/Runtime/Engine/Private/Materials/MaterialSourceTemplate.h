...
struct FMaterialSourceTemplate
{
	...
	/** Per shader platform flags that are set true if the template is invalidated by a file change. */
	bool bFileWatchInvalidation[SP_NumPlatforms];

	/** Handle for file watcher. */
