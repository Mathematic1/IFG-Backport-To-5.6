...
private:
	...
	// Used when SetAsStatic and/or SetAsDynamic are called concurrently
	UE::FMutex SetAsLock;
	...
	FORCEINLINE_DEBUGGABLE void SetAsStatic(FDynamicRenderAssetInstanceManager& DynamicComponentManager, const UPrimitiveComponent* Primitive, bool bIsConcurrent = false);
	FORCEINLINE_DEBUGGABLE void SetAsDynamic(FDynamicRenderAssetInstanceManager& DynamicComponentManager, FStreamingTextureLevelContext& LevelContext, const UPrimitiveComponent* Primitive, bool bIsConcurrent = false);
};
