...
public:
	virtual void InitRHI(FRHICommandListBase& RHICmdList) override
	{
		VertexBufferRHI = UE::RHIResourceUtils::CreateVertexBufferFromArray(RHICmdList, TEXT("FDummyVertexBuffer"), BUF_Static, MakeConstArrayView(GDummyVertexBufferData));
	}
};
