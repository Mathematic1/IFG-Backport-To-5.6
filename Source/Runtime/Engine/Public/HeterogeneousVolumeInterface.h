...
DECLARE_STATS_GROUP(TEXT("Heterogeneous Volumes RT"), STATGROUP_HeterogeneousVolumesRT, STATCAT_HeterogeneousVolumes);
DECLARE_STATS_GROUP(TEXT("Heterogeneous Volumes GT"), STATGROUP_HeterogeneousVolumesGT, STATCAT_HeterogeneousVolumes);
