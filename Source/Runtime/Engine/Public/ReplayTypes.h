...
inline constexpr uint32 NETWORK_DEMO_MAGIC = 0x2CF5A13D;
PRAGMA_DISABLE_DEPRECATION_WARNINGS
UE_DEPRECATED(5.2, "Now using custom versions, see FReplayCustomVersion::Latest")
inline constexpr uint32 NETWORK_DEMO_VERSION = ENetworkVersionHistory::HISTORY_LATEST;
UE_DEPRECATED(5.2, "Using custom versions instead going forward.")
inline constexpr uint32 MIN_NETWORK_DEMO_VERSION = ENetworkVersionHistory::HISTORY_CHARACTER_MOVEMENT;
PRAGMA_ENABLE_DEPRECATION_WARNINGS

UE_DEPRECATED(5.2, "No longer used.")
inline constexpr uint32 NETWORK_DEMO_METADATA_MAGIC = 0x3D06B24E;
UE_DEPRECATED(5.2, "No longer used.")
inline constexpr uint32 NETWORK_DEMO_METADATA_VERSION = 0;
