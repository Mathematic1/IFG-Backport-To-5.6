...
struct TLocation
{
	...
	{
		using UScalarType = std::make_unsigned_t<ScalarType>;

		return uint32((UScalarType)CellLocation.Coord.X * 1150168907 + (UScalarType)CellLocation.Coord.Y * 1235029793 + (UScalarType)CellLocation.Coord.Z * 1282581571 + (UScalarType)CellLocation.Level * 1264559321);
	}
