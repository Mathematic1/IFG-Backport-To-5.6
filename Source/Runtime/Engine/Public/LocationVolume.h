 ...
 */
UCLASS(BlueprintType, Blueprintable, HideCategories=(Mobility, HLOD, Collision, Navigation, BrushSettings, Tags, Cooking, Replication, Networking, Actor, Mobile, RayTracing, AssetUserData, LevelInstance, DataLayers), MinimalAPI)
