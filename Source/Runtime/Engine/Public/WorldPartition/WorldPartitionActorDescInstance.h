...
public:
	...
	virtual bool GetActorIsEditorOnlyLoadedInPIE() const { return ActorDesc->GetActorIsEditorOnlyLoadedInPIE(); }
	...
	int32 GetAsyncLoadID() const { return AsyncLoadID; }
...
protected:
	virtual FBox GetLocalEditorBounds() const { return ActorDesc->GetEditorBounds(); }
