...
struct FWorldPartitionPerWorldSettings
{
	...
	UPROPERTY()
	TArray<TSoftObjectPtr<const UDataLayerAsset>> NotLoadedDataLayers;

	UPROPERTY()
	TArray<TSoftObjectPtr<const UDataLayerAsset>> LoadedDataLayers;
#endif
};
...
public:
	...
	ENGINE_API TArray<const UDataLayerInstance*> GetWorldDataLayersNotLoadedInEditor(UWorld* InWorld) const;
	ENGINE_API TArray<const UDataLayerInstance*> GetWorldDataLayersLoadedInEditor(UWorld* InWorld) const;

	ENGINE_API TArray<UDataLayerInstance*> GetWorldDataLayersNotLoadedInEditor(UWorld* InWorld);
	ENGINE_API TArray<UDataLayerInstance*> GetWorldDataLayersLoadedInEditor(UWorld* InWorld);

	ENGINE_API void SetWorldDataLayersNonDefaultEditorLoadStates(UWorld* InWorld, const TArray<const UDataLayerInstance*>& InDataLayersLoadedInEditor, const TArray<const UDataLayerInstance*>& InDataLayersNotLoadedInEditor);
