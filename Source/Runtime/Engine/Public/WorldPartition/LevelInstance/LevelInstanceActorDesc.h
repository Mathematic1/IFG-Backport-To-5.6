...
public:
	...
	virtual UActorDescContainer* GetChildContainer() const override { check(IsChildContainerInstance()); return ChildContainer.Get(); }

	virtual bool HasStandaloneHLOD() const override { return bHasStandaloneHLOD; }
