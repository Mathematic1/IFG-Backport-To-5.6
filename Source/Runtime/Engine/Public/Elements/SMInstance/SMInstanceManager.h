...
public:
	...
	/**
	* Optionally specify a different class for a proxy object than the default one.
	* This can be useful if a full UObject is needed to represent the SM Instance
	*/
...
class USMInstanceProxyEditingObject : public UObject
{
	GENERATED_BODY()
