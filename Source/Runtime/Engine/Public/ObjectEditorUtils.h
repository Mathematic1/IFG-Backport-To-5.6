...
#include "ObjectEditorUtils.generated.h"
...
namespace FObjectEditorUtils
{
	...
	/**
	 * Check if this struct is experimental for Valkyrie
	 * @param Struct the struct to inspect
	 * @return true if it is experimental, otherwise false
	 */
	ENGINE_API bool IsStructExperimentalForValkyrie(const UStruct& Struct);

	/**
	 * Check if this struct is deprecated for Valkyrie
	 * @param Struct the struct to inspect
	 * @return true if it is deprecated, otherwise false
	 */
	ENGINE_API bool IsStructValkyrieDeprecatedForValkyrie(const UStruct& Struct);
...
public:
	...
	UPROPERTY(config)
	FName DevelopmentStatusKey{TEXT("Valkyrie_DevelopmentStatus")};
	FString DevelopmentStatusValue_Experimental{TEXT("Experimental")};

	UPROPERTY(config)
	FName DeprecationStatusKey{TEXT("Valkyrie_DeprecationStatus")};
	FString DeprecationStatusValue_Deprecated{TEXT("Deprecated")};
};
