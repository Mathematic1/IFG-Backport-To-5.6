...
static const FSlateBrush* BorderBrushFromDockDirection(SDockingNode::RelativeDirection DockDirection)
{
	...
	{
		case SDockingNode::LeftOf:  return FCoreStyle::Get().GetBrush( "Docking.Cross.BorderLeft" );
		case SDockingNode::Above:   return FCoreStyle::Get().GetBrush( "Docking.Cross.BorderTop" );
		case SDockingNode::RightOf: return FCoreStyle::Get().GetBrush( "Docking.Cross.BorderRight" );
		case SDockingNode::Below:   return FCoreStyle::Get().GetBrush( "Docking.Cross.BorderBottom" );
		default:
		case SDockingNode::Center:  return FCoreStyle::Get().GetBrush( "Docking.Cross.BorderCenter" );
	}
}
