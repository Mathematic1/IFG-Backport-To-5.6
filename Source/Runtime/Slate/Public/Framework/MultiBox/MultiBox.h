...
private:
	...
	/** Resize parameters which determine how this block behaves during toolbar resizing. */
	TAttribute<FMenuEntryResizeParams> ResizeParams;
};
...
public:
	 ...
	 */
	UE_DEPRECATED(5.6, "Use the const version of GetMultiBlockLocation")
...
public:
	...
	SLATE_API virtual EMultiBlockLocation::Type GetMultiBlockLocation() const override;
...
public:
	...
	*/
	...
	/** Rebuilds this MultiBox widget using the input MultiBox */
	SLATE_API void UpdateMultiBoxWidget(TSharedRef<FMultiBox> InMultiBox);
	...
	*/
	...
	bool ShouldShowMenuSearchField() const;

private:
	/** Adds a block Widget to this widget */
	SLATE_API void AddBlockWidget(const FMultiBlock& Block, TSharedPtr<SHorizontalBox> HorizontalBox, TSharedPtr<SVerticalBox> VerticalBox, TSharedPtr<SPanel> Panel, EMultiBlockLocation::Type InLocation, bool bSectionContainsIcons, TSharedPtr<const FToolBarComboButtonBlock> OptionsBlock);
	...
	SLATE_API EVisibility GetSearchBoxVisibility() const;
...
private:
	...
	/** Box panel used for other boxes, e.g., horizontal wrapping toolbar */
	TSharedPtr<SPanel> MainPanelBox;
	...
	/** The final multibox widgets as they were added to the UI, linked to their original MultiBlocks. */
	TMap<TSharedPtr<SWidget>, TSharedPtr<const FMultiBlock>> FinalMultiBoxWidgets;
