...
private:
	...
	// On Linux there is a hack in SDL to already delayed the showing of notification that is not interacting well with this optimization.
	static constexpr bool bShowNotificationImmediately = PLATFORM_LINUX;
};
