...
public:
	 ...
	 * 
	 * @param The Filename to export the theme to
	 * @return true if the theme was successfully exported
	 */
	SLATECORE_API bool ExportCurrentThemeTo(const FString& Filename);
...
private:
	...
	bool WriteCurrentTheme(FString& OutString);
