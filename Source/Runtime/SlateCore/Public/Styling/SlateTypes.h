...
struct FTextBlockStyle : public FSlateWidgetStyle
{
	...
	UE_DEPRECATED(5.6, "Use SetFont using FCompositeFont instead. FSlateFontInfo's constructors using a FontName are deprecated.")
	FTextBlockStyle& SetFont(const FName& InFontName, float InSize);
	UE_DEPRECATED(5.6, "Use SetFont using FCompositeFont instead. FSlateFontInfo's constructors using a FontName are deprecated.")
	FTextBlockStyle& SetFont(const FString& InFontName, float InSize);
	UE_DEPRECATED(5.6, "Use SetFont using FCompositeFont instead. FSlateFontInfo's constructors using a FontName are deprecated.")
	FTextBlockStyle& SetFont(const WIDECHAR* InFontName, float InSize);
	UE_DEPRECATED(5.6, "Use SetFont using FCompositeFont instead. FSlateFontInfo's constructors using a FontName are deprecated.")
	FTextBlockStyle& SetFont(const ANSICHAR* InFontName, float InSize);
	UE_DEPRECATED(5.6, "Use SetFont using FCompositeFont instead. FSlateFontInfo's constructors using a FontName are deprecated.")
	FTextBlockStyle& SetFontName(const FName& InFontName);
	UE_DEPRECATED(5.6, "Use SetFont using FCompositeFont instead. FSlateFontInfo's constructors using a FontName are deprecated.")
	FTextBlockStyle& SetFontName(const FString& InFontName);
	UE_DEPRECATED(5.6, "Use SetFont using FCompositeFont instead. FSlateFontInfo's constructors using a FontName are deprecated.")
	FTextBlockStyle& SetFontName(const WIDECHAR* InFontName);
	UE_DEPRECATED(5.6, "Use SetFont using FCompositeFont instead. FSlateFontInfo's constructors using a FontName are deprecated.")
	FTextBlockStyle& SetFontName(const ANSICHAR* InFontName);
...
struct FButtonStyle : public FSlateWidgetStyle
{
	...
	FButtonStyle& SetClickedSound( const FSlateSound& InClickedSound ){ ClickedSlateSound = InClickedSound; return *this; }
...
struct FEditableTextStyle : public FSlateWidgetStyle
{
	...
	FEditableTextStyle& SetFont(const FName& InFontName, float InSize);
...
struct FEditableTextBoxStyle : public FSlateWidgetStyle
{
	...
	UE_DEPRECATED(5.6, "Use SetFont using FSlateFontInfo instead. FSlateFontInfo's constructors using a FontName are deprecated.")
	FEditableTextBoxStyle& SetFont(const FName& InFontName, float InSize);
...
struct FWindowStyle : public FSlateWidgetStyle
{
    ...
    FWindowStyle& SetEnterFullscreenButtonStyle( const FButtonStyle& InEnterFullscreenButtonStyle ){ EnterFullscreenButtonStyle = InEnterFullscreenButtonStyle; return *this; }

	/** Style used to draw the exit fullscreen button */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Appearance)
	FButtonStyle ExitFullscreenButtonStyle;
	FWindowStyle& SetExitFullscreenButtonStyle( const FButtonStyle& InExitFullscreenButtonStyle ){ ExitFullscreenButtonStyle = InExitFullscreenButtonStyle; return *this; }
