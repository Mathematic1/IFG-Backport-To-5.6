...
enum class ESlateAttributeBindAction
{
	None = 0, // Do nothing when an attribute is bound.
	Initialize = 1, // Initialize the attribute value from the binding.
};
ENUM_CLASS_FLAGS(ESlateAttributeBindAction)
#if UE_SLATE_WITH_ATTRIBUTE_INITIALIZATION_ON_BIND
#	define UE_SLATE_WITH_ATTRIBUTE_DEFAULT_INITIALIZATION_ACTION ESlateAttributeBindAction::Initialize
#else
#	define UE_SLATE_WITH_ATTRIBUTE_DEFAULT_INITIALIZATION_ACTION ESlateAttributeBindAction::None
#endif
