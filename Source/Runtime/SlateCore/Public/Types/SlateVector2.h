...
#if UE_REPORT_SLATE_VECTOR_DEPRECATION && UE_WARNINGS_AS_ERRORS
	#define UE_SLATE_DEPRECATED_VECTOR_VIRTUAL_FUNCTION final
#else
...
#undef UE_REPORT_SLATE_VECTOR_DEPRECATION
