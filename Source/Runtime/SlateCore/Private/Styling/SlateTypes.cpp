...
FTextBlockStyle& FTextBlockStyle::SetFont(const FName& InFontName, float InSize) { Font = FSlateFontInfo(InFontName, InSize); return *this; }
FTextBlockStyle& FTextBlockStyle::SetFont(const FString& InFontName, float InSize) { Font = FSlateFontInfo(*InFontName, InSize); return *this; }
FTextBlockStyle& FTextBlockStyle::SetFont(const WIDECHAR* InFontName, float InSize) { Font = FSlateFontInfo(InFontName, InSize); return *this; }
FTextBlockStyle& FTextBlockStyle::SetFont(const ANSICHAR* InFontName, float InSize) { Font = FSlateFontInfo(InFontName, InSize); return *this; }
FTextBlockStyle& FTextBlockStyle::SetFontName(const FName& InFontName) { Font = FSlateFontInfo(InFontName, Font.GetClampSize()); return *this; }
FTextBlockStyle& FTextBlockStyle::SetFontName(const FString& InFontName) { Font = FSlateFontInfo(InFontName, Font.GetClampSize()); return *this; }
FTextBlockStyle& FTextBlockStyle::SetFontName(const WIDECHAR* InFontName) { Font = FSlateFontInfo(InFontName, Font.GetClampSize()); return *this; }
FTextBlockStyle& FTextBlockStyle::SetFontName(const ANSICHAR* InFontName) { Font = FSlateFontInfo(InFontName, Font.GetClampSize()); return *this; }
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
FEditableTextStyle& FEditableTextStyle::SetFont(const FName& InFontName, float InSize) { Font = FSlateFontInfo(InFontName, InSize); return *this; }
PRAGMA_ENABLE_DEPRECATION_WARNINGS
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
FEditableTextBoxStyle& FEditableTextBoxStyle::SetFont(const FName& InFontName, float InSize) { return SetFont(FSlateFontInfo(InFontName, InSize)); }
PRAGMA_ENABLE_DEPRECATION_WARNINGS
