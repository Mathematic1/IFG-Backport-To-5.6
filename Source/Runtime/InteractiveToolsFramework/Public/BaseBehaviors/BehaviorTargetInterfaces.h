...
/**
 * ITwoAxisPropertyEditBehaviorTarget allows tools to
 * expose properties to drag-based property edit behaviors.
 */
...
public:
	...
	struct IPropertyInterface
	{
		...
		virtual FText GetName() = 0;								// Get a name for this virtual property (for display purposes).
		virtual float GetValue() = 0;
		virtual void SetValue(float NewValue) = 0;
		virtual float GetEditRate() { return 0.003f; }				// Scales how quickly this property is edited with respect to a fixed mouse movement.
		virtual float MutateDelta(float Delta) { return Delta; }	// Provides a hook to further augment the delta that is about to be applied to this property.
...
public:
	...
	virtual FKey GetCaptureKey() { return EKeys::B; }
