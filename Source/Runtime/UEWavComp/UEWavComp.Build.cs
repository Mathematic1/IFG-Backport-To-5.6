...
public class UEWavComp : ModuleRules
{
	public UEWavComp(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		else if (Target.Platform == UnrealTargetPlatform.Win64 && Target.WindowsPlatform.Architecture == UnrealArch.Arm64)
		{
			string LibPath = Path.Combine(ModuleDirectory, "Lib");
			PublicAdditionalLibraries.Add(Path.Combine(LibPath, "uewav_warm64.lib"));
			bWithLib = true;
		}
