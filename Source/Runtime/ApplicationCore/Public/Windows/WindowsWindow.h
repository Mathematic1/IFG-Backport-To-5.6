...
public:
	...
	*/
	...
	// Attempts to retrieve the window's pixels using PrintWindow (https://learn.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-printwindow).
	// Only the client area's pixels are retrieved, which excludes the title bar, border, etc.
