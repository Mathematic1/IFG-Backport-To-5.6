...
struct FInputDeviceGyroAutoCalibrationProperty : public FInputDeviceProperty
{
	...
	static FName PropertyName() { return FName("InputDeviceGyroAutoCalibration"); }
 ...
 * 
 * NOTE: Dynamic Triggers allow for Release and Press to be triggered even if the user fails to fully release the trigger before beginning another press.
 * Smaller deadzones increase this effect. A deadzone of 1.0 isn't dynamic at all.
 */
struct FInputDeviceTriggerDynamicReleaseDeadZoneProperty : public FInputDeviceTriggerProperty
{
	...
	FInputDeviceTriggerDynamicReleaseDeadZoneProperty(EInputDeviceTriggerMask InAffectedTriggers, float InDeadZone)
		...
		, DeadZone(InDeadZone)
	{
		AffectedTriggers = InAffectedTriggers;
	}

	static FName PropertyName() { return FName("InputDeviceTriggerDynamicReleaseDeadZone"); }
