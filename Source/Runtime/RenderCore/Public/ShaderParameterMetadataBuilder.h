...
public:
	...
	RENDERCORE_API void AddTexture(
		const TCHAR* Name,
		const TCHAR* ShaderType,
		EShaderPrecisionModifier::Type Precision = EShaderPrecisionModifier::Float
	);

	RENDERCORE_API void AddRDGTexture(
		const TCHAR* Name,
		const TCHAR* ShaderType,
		EShaderPrecisionModifier::Type Precision = EShaderPrecisionModifier::Float
	);

	RENDERCORE_API void AddSampler(
		const TCHAR* Name,
		const TCHAR* ShaderType,
		EShaderPrecisionModifier::Type Precision = EShaderPrecisionModifier::Float
	);

	RENDERCORE_API void AddRenderTargetBindingSlots(
		const TCHAR* Name = TEXT("RenderTargets"),
