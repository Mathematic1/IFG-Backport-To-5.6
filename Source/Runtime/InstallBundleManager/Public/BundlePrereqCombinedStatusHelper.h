...
public:
	...
	struct FCombinedProgress
	{
		...
		float ProgressPercent = 0.0f; // Download and Install progress combined
		int32 InstalledBundlesCount = 0;
		int32 TotalBundlesCount = 0;
		TArray<FBuildInstallerStat> Stats; // Used for additional information about the installs
...
private:
	...
	INSTALLBUNDLEMANAGER_API void UpdateCombinedProgress();
