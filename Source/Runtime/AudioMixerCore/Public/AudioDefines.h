...
namespace Audio
{
	...
	// Magic numbers for mono upmix method
	inline constexpr float MonoUpmixFullVolume = 1.0f;
	inline constexpr float MonoUpmixEqualPower = 0.707f;
	inline constexpr float MonoUpmixLinear = 0.5f;
