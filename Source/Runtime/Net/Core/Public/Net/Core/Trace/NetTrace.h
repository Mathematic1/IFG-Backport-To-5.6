...
#define UE_NET_TRACE_POLL_OBJECT_SCOPE(...) UE_NET_TRACE_INTERNAL_POLL_OBJECT_SCOPE(__VA_ARGS__)
#define UE_NET_TRACE_POLL_OBJECT_IS_WASTE() UE_NET_TRACE_INTERNAL_POLL_OBJECT_IS_WASTE
#define UE_NET_TRACE_QUANTIZE_OBJECT_SCOPE(...) UE_NET_TRACE_INTERNAL_QUANTIZE_OBJECT_SCOPE(__VA_ARGS__)
#define UE_NET_TRACE_WRITE_OBJECT_SCOPE(...) UE_NET_TRACE_INTERNAL_WRITE_OBJECT_SCOPE(__VA_ARGS__)

#define UE_NET_TRACE_SUBOBJECT(ParentHandle, SubObjectHandle) UE_NET_TRACE_INTERNAL_SUBOBJECT(ParentHandle, SubObjectHandle)
...
#define UE_NET_TRACE_POLL_OBJECT_SCOPE(...)
#define UE_NET_TRACE_POLL_OBJECT_IS_WASTE()
#define UE_NET_TRACE_QUANTIZE_OBJECT_SCOPE(...)
#define UE_NET_TRACE_WRITE_OBJECT_SCOPE(...)

#define UE_NET_TRACE_SUBOBJECT(...)
